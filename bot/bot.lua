...
io.write('\n\27[1;33m📌 ارسل ايديك كمطور اساسي \27[0;39;49m\n') 
local sudo_id =  tonumber(io.read()) 
io.write('\n\27[1;33m📌 ارسل توكن بوتك \27[0;39;49m\n') 
local token = io.read() 
io.write('\n\27[1;33m 📌 ارسل معرف قناتك بدون @ \27[0;39;49m\n') 
local botusea = io.read()
io.write('\n\27[1;33m 📌 ارسل ايدي بوتك \27[0;39;49m\n') 
local botid = io.read()
io.write('\n\27[1;33m 📌 ارسل معرف المطور بدون @\27[0;39;49m\n') 
...
info_text = [[
 ...
 اتمنا التوفيق للجميع ❤
    ...
    --كود صنع ملف الرن فقط تابعه لسورس الزعيم
...
function load_plugins() 
   ...
   for k, v in pairs(config.enabled_plugins) do 
      ...
      if not ok then 
         print('\27[31m❌ • هناك خطا في ملف '..v..'\27[39m') 
         print(tostring(io.popen("lua plugins/"..v..".lua"):read('*all'))) 
         print('\27[31m'..err..'\27[39m') 
      end 
   end 
   print('\n'..#config.enabled_plugins..' 📁 • عدد الملفات •\n\n📥 جار تشغيل سورس ستورم 📌\n') 
end 
